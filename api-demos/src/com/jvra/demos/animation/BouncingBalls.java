...
//            float start = newBall.getX();
//            float end = getHeight() - 50f;
//            float h = getHeight();
//            float eventY = event.getY();
//            int duration = (int) (5000 * ((h - eventY) / h));
//
//            ValueAnimator bounceAnim = ObjectAnimator.ofFloat(newBall, "y", start, end);
//            bounceAnim.setDuration(duration);
//            bounceAnim.setInterpolator(new AccelerateInterpolator());
//
//            ValueAnimator squash = ObjectAnimator.ofFloat(newBall, "x", newBall.getX(), newBall.getX() - 25f);
//            squash.setDuration(duration / 4);
//            squash.setRepeatCount(1);
//            squash.setRepeatMode(ValueAnimator.REVERSE);
//            squash.setInterpolator(new DecelerateInterpolator());
//
//
//            ValueAnimator anim2 = ObjectAnimator.ofFloat(newBall, "width", newBall.getWidth(), newBall.getWidth() + 50);
...
//
//
//            ValueAnimator anim3 = ObjectAnimator.ofFloat(newBall, "y", end, end + 25f);
//            anim3.setDuration(duration / 4);
//            anim3.setRepeatCount(10);
//            anim3.setRepeatMode(ValueAnimator.REVERSE);
//            anim3.setInterpolator(new DecelerateInterpolator());
//
//
//            ValueAnimator anim4 = ObjectAnimator.ofFloat(newBall, "height", newBall.getHeight(), newBall.getHeight() - 25);
//            anim4.setDuration(duration / 4);
//            anim4.setRepeatCount(1);
//            anim4.setRepeatMode(ValueAnimator.REVERSE);
//            anim4.setInterpolator(new DecelerateInterpolator());
//
//
//            ValueAnimator anim5 = ObjectAnimator.ofFloat(newBall, "y", end, start);
//            anim5.setDuration(duration / 4);
...
//
//            AnimatorSet bounce = new AnimatorSet();
//            bounce.play(bounceAnim).before(squash);
//            bounce.play(squash).with(anim2);
//            bounce.play(squash).with(anim3);
//            bounce.play(squash).with(anim4);
//            bounce.play(anim5).after(anim3);
//
//
//            ValueAnimator anim = ObjectAnimator.ofFloat(newBall, "alpha", 1f, 0f);
