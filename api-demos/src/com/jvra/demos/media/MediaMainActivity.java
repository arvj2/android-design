...
import com.jvra.demos.media.AudioFxDemo;

import java.util.Arrays;
import java.util.List;
import java.util.Map;

public class MediaMainActivity extends ListActivity implements AdapterView.OnItemClickListener{
    /**
    ...
    private List<Entry> getEntries(){
        return Arrays.asList(
                new Entry(AudioFxDemo.class,"AudioFxDemo" )
        );
    }
